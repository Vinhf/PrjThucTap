...
const Profile = () => {
  ...
  const handleRedirect = () => {
    navigate(`/edit-user/${user.userId}`); // Truyền userId qua URL
  };
          ...
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              ...
              >
                ...
                <button onClick={handleRedirect} name="profile" id="profile" className="sr-only" />
              </label>
            </div>
          </div>
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-4xl p-6 bg-gray-100 dark:bg-gray-800 rounded-lg">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">{user?.school_name}</p>
                </div>
                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                  <h5 className="text-lg font-medium text-gray-700 dark:text-gray-200">
                    Role
                ...
                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">{user?.address}</p>
                </div>
                <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
                  <h5 className="text-lg font-medium text-gray-700 dark:text-gray-200">
                    Status
